...
files = ['/home/antareep/codes/class_public-master/output/ULA00_cl.dat', '/home/antareep/codes/class_public-master/output/explanatory00_cl.dat']
data = []
for data_file in files:
    data.append(np.loadtxt(data_file))
roots = ['ULA00_cl', 'explanatory00_cl']
